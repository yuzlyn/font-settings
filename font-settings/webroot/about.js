const ABOUT_TRANSLATIONS = {
  "zh-CN": {
    ...
    featureWeights: "为可变字体提供 100–900 字重调节，上传可变字体后自动显示字重滑块。",
  ...
  "zh-TW": {
    ...
    featureWeights: "為可變字型提供 100–900 字重調節，上傳可變字型後自動顯示字重滑桿。",
  ...
  "en-US": {
    ...
    featureWeights: "Adjust variable fonts across 100-900 weight, with the slider appearing for uploaded variable fonts.",
